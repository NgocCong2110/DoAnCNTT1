...
@Component({
  selector: 'app-component-thong-ke-tuyen-dung-cua-cong-ty',
  imports: [BaseChartDirective, CommonModule],
  templateUrl: './component-thong-ke-tuyen-dung-cua-cong-ty.html',
  styleUrl: './component-thong-ke-tuyen-dung-cua-cong-ty.css'
})
export class ComponentThongKeTuyenDungCuaCongTy implements OnInit {
  thongTin: any;
  ...
  laySoLieuUngVien() {
    ...
    this.http.post<API_RESPONSE>(
      'http://localhost:7000/api/API_WEB/laySoLuongUngVien',
